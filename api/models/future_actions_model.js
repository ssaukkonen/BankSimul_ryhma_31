...
const future_actions = {
  ...
  futureActions10: function(idaccount,pagenumber, callback) {
    ...
    return db.query('select amount,date,action_type,ref_num,message,recipient_number,action_date from future_actions where id_account=? order by date desc limit ?,10',[idaccount, pagenumber], callback); 
  },
