...
QT_MOC_LITERAL(1, 12, 21), // "sendSignalToInterface"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 22) // "signalReceivedFromCard"

    },
    "engineclass\0sendSignalToInterface\0\0"
    "signalReceivedFromCard"
};
...
void engineclass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSignalToInterface(); break;
        ...
        {
            using _t = void (engineclass::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&engineclass::sendSignalToInterface)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void engineclass::sendSignalToInterface()
{
